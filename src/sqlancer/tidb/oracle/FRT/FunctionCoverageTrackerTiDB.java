...
public class FunctionCoverageTrackerTiDB {
    ...
    public FunctionCoverageTrackerTiDB() {
        this(false);
    }

    public FunctionCoverageTrackerTiDB(int showMissed) {
        this(showMissed != 0);
    }

    public FunctionCoverageTrackerTiDB(boolean showMissed) {
    ...
    public void report() {
        ...
        System.out.println();
        System.out.println("=== TiDB Function Coverage Report ===");
