...
public final class TiDBErrors {
    ...
    public static List<String> getExpressionErrors() {
        ...
        errors.add("no enough space");
        errors.add("Check ingest environment failed");
        errors.add("Check ingest environment failed: no enough space in /tmp/tidb/tmp_ddl-4000");
