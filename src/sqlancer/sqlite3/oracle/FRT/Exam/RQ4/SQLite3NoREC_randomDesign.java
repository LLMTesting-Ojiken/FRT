...
public class SQLite3NoREC_randomDesign implements TestOracle<SQLite3GlobalState> {
    ...
    public SQLite3NoREC_randomDesign(SQLite3GlobalState globalState) {
    ...
    private boolean runOne(FunctionCoverageTracker tracker) {
        String s = SQLite3Visitor.asString(
